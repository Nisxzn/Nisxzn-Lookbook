...
const certs = [
  { label: 'NPTEL : Human Computer Interaction (Elite)', image: '/Certifications/NPTEL.png' },
  { label: 'Anthropic : Model Context Protocol advanced', image: '/Certifications/MCP-advanced.png', url: 'https://verify.skilljar.com/c/6crwxvqgcdom' },
  { label: 'Anthropic : AI Fluency', image: '/Certifications/ai-fluency.png', url: 'https://verify.skilljar.com/c/o6t8cozq4p87' },
  { label: 'DataBricks : Advanced ML operations', image: '/Certifications/Advanced ML operations.png' },
]
