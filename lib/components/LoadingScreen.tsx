...
const COUNT_MS = 1800 // number climbs 0→100 (shortened for faster LCP)
const TYPE_MS = 800 // text types out (finishes early so it's readable)
const HOLD_MS = 500 // pause at 100% so the line can be read
const FADE_MS = 400 // fade-out

const TYPE_TEXT = 'PS: Most of my best ideas arrive long after sunset.'
