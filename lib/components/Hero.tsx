...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        Building software that thinks, learns, and scales.
      </p>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: isMobile ? '480px' : dimensions.portraitHero.height,
        ...
        >
          <Image
            src="/images/hero_portrait3.png"
            alt="Nithish Parameswaran - Full Stack AI/ML Engineer"
            fill
            priority
